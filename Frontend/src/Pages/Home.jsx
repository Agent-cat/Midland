    ...
    <div className="min-h-screen">
      <div className="relative h-[100vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
          <h1 className="text-6xl md:text-9xl font-bold mb-8 tracking-tight leading-tight font-serif">
            MIDLAND
          </h1>
          <p className="text-xl md:text-2xl mb-12 max-w-3xl font-light tracking-wide leading-relaxed">
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-4 bg-gradient-to-r from-red-500 to-red-700 bg-clip-text text-transparent font-serif">
              Featured Properties
            </h2>
