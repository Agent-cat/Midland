...
const Sell = ({ refreshProperties }) => {
  ...
  return (
    <div className="container mx-auto mt-24 p-8 bg-gradient-to-br from-gray-50 to-red-50 rounded-xl shadow-lg">
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border-2 rounded-lg focus:ring-2 focus:ring-red-300 focus:border-red-500 transition-all duration-300"
                  required
                />
              </div>
